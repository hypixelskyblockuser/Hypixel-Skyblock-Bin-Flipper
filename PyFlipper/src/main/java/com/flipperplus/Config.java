...
public class Config extends Vigilant {
    ...
    public Config() {
        super(CONFIG_FILE, "Flipper+ Config", new JVMAnnotationPropertyCollector(), new CustomSorting());
        initialize();
    }
    ...
    public static void github() {
        UDesktop.browse(URI.create("https://github.com/Trueh1/FlipperPlus"));
    }
    ...
    public static void discord() {
        UDesktop.browse(URI.create("https://discord.gg/flipper"));
    }
}
