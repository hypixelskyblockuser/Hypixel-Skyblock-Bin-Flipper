...
import com.flipperplus.objects.BestSellingMethod;
...
public class Utils {
    ...
    public static void sendMessageWithPrefix(String message) {
        UChat.chat(EnumChatFormatting.GOLD + (EnumChatFormatting.WHITE + "[" + EnumChatFormatting.YELLOW + "FLIPER+" + EnumChatFormatting.WHITE + "] ") + message.replaceAll("&", "§"));
    }

    public static void sendMessageWithPrefix(String message, ClickEvent clickEvent) {
        UTextComponent result = new UTextComponent(EnumChatFormatting.GOLD + (EnumChatFormatting.WHITE + "[" + EnumChatFormatting.YELLOW + "FLIPER+" + EnumChatFormatting.WHITE + "] ") + message.replaceAll("&", "§"));
