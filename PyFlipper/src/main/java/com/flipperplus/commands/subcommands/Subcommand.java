...
public interface Subcommand {
     ...
     * It will look like: /nef subcommand (usage)
     */
    String getCommandUsage();

    /**
     * Returns a String that will be show after the subcommand usage in the help message.
     * It will look like: /nef subcommand (usage) (description [in a different color])
     */
     ...
     * subcommand itself, example: /nef subcommand arg1 arg2 will have {"arg1",
     * "arg2"} as its args
     */
