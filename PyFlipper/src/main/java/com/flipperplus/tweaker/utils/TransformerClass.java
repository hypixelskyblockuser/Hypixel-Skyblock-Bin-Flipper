package com.flipperplus.tweaker.utils;

import com.flipperplus.tweaker.PreTransformationChecks;
...
public enum TransformerClass {
    ...
    private final String notchClass18;

    TransformerClass(String seargeClass, String notchClass18) {
        this.seargeClass = seargeClass;
        this.notchClass18 = notchClass18;

        if (PreTransformationChecks.deobfuscated || !PreTransformationChecks.usingNotchMappings) {
            name = seargeClass;
        } else {
            name = notchClass18;
        }
