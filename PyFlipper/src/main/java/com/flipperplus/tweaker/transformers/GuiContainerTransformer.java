package com.flipperplus.tweaker.transformers;

import com.flipperplus.tweaker.utils.TransformerClass;
import com.flipperplus.tweaker.utils.TransformerMethod;
                ...
                while (iterator.hasNext()) {
                    ...
                    if (abstractNode instanceof MethodInsnNode && abstractNode.getOpcode() == Opcodes.INVOKESPECIAL) {
                        ...
                        if (methodInsnNode.owner.equals(TransformerClass.GuiContainer.getNameRaw()) && TransformerMethod.drawSlot.matches(methodInsnNode)) {
                            methodNode.instructions.insert(abstractNode, new MethodInsnNode(Opcodes.INVOKESTATIC, "com/flipperplus/tweaker/hooks/GuiContainerHook",
